...
const bg = 'https://raw.githubusercontent.com/erenesto/interactive-password-validator/d4344fd1a7620393a18d18a17ffb9dcf95f6887f/src/assets/bg.svg'
...
function App() {
  const [lock, setLock] = React.useState(lockIcon.open);
  ...
  return (
    <div className="App" style={{ backgroundImage: `url(${bg})` }}>
      <div className="form-box">
       ...
       <a className="github-button" href="https://github.com/izthiaka" target="_blank">★ Github</a>
    </div>
  );
}
